...
const CONFIG = {
  ...
  STYLES: {
    ...
    ENTRY_UNVIEWED: 'color: #147af3; padding-left: 2rem; cursor: pointer; font-size: var(--type-body-l-size); line-height: 1.6; font-weight: 600; border: none;',
    ENTRY_VIEWED: 'color: #7326d3; padding-left: 2rem; cursor: pointer; font-size: var(--type-body-l-size); line-height: 1.6; font-weight: normal; border: none;',
