...
(() => {
  ...
  function initSidekickCompatMode() {
    window.hlx.sidekickScript = document.querySelector('script[src$="/sidekick/app-hlx2.js"]');
  ...
  if (!window.hlx || !window.hlx.sidekick) {
    ...
    moduleScript.src = (appScript && appScript.getAttribute('src').replace('app-hlx2.js', 'module-hlx2.js'))
      || 'https://www.hlx.live/tools/sidekick/module-hlx2.js';
