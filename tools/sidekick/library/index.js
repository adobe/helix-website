...
`,xc=Object.defineProperty,zc=Object.getOwnPropertyDescriptor;class Tr extends nt(_,{validSizes:["s","m","l"]}){constructor(){super(...arguments),this.vertical=!1}render(){return u``}firstUpdated(t){super.firstUpdated(t),this.setAttribute("role","separator")}updated(t){super.updated(t),t.has("vertical")&&(this.vertical?this.setAttribute("aria-orientation","vertical"):this.removeAttribute("aria-orientation"))}}Tr.styles=[Qo],((r,t,e,o)=>{for(var a,s=o>1?void 0:o?zc(t,e):t,c=r.length-1;c>=0;c--)(a=r[c])&&(s=(o?a(t,e,s):a(s))||s);o&&s&&xc(t,e,s)})([m({type:Boolean,reflect:!0})],Tr.prototype,"vertical",2),y("sp-divider",Tr),y("sp-close-button",Ko),y("sp-icon-info",class extends S{render(){return Z(u),(({width:r=24,height:t=24,hidden:e=!1,title:o="Info"}={})=>K`<svg
    xmlns="http://www.w3.org/2000/svg"
    height=${t}
    viewBox="0 0 36 36"
    width=${r}
...
`,jc=Object.defineProperty,Ac=Object.getOwnPropertyDescriptor,Lr=(r,t,e,o)=>{for(var a,s=o>1?void 0:o?Ac(t,e):t,c=r.length-1;c>=0;c--)(a=r[c])&&(s=(o?a(t,e,s):a(s))||s);return o&&s&&jc(t,e,s),s};const Ec=["negative","positive","info","error","warning"];class Be extends _{constructor(){super(...arguments),this.open=!1,this._timeout=null,this._variant="",this.countdownStart=0,this.nextCount=-1,this.doCountdown=t=>{this.countdownStart||(this.countdownStart=performance.now()),t-this.countdownStart>this._timeout?(this.shouldClose(),this.countdownStart=0):this.countdown()},this.countdown=()=>{cancelAnimationFrame(this.nextCount),this.nextCount=requestAnimationFrame(this.doCountdown)},this.holdCountdown=()=>{this.stopCountdown(),this.addEventListener("focusout",this.resumeCountdown)},this.resumeCountdown=()=>{this.removeEventListener("focusout",this.holdCountdown),this.countdown()}}static get styles(){return[Cc]}set timeout(t){const e=typeof t!==null&&t>0?Math.max(6e3,t):null,o=this.timeout;e&&this.countdownStart&&(this.countdownStart=performance.now()),this._timeout=e,this.requestUpdate("timeout",o)}get timeout(){return this._timeout}set variant(t){if(t===this.variant)return;const e=this.variant;Ec.includes(t)?(this.setAttribute("variant",t),this._variant=t):(this.removeAttribute("variant"),this._variant=""),this.requestUpdate("variant",e)}get variant(){return this._variant}renderIcon(t){switch(t){case"info":return u`
                    <sp-icon-info
                        label="Information"
                        class="type"
                    ></sp-icon-info>
...
`],Rc=Object.defineProperty,Uc=Object.getOwnPropertyDescriptor,rs=(r,t,e,o)=>{for(var a,s=o>1?void 0:o?Uc(t,e):t,c=r.length-1;c>=0;c--)(a=r[c])&&(s=(o?a(t,e,s):a(s))||s);return o&&s&&Rc(t,e,s),s};class Oe extends _{constructor(){super(...arguments),this.heading="",this.description=""}static get styles(){return[es,_c,Mc]}render(){return u`
...
`,Fc=Object.defineProperty,Vc=Object.getOwnPropertyDescriptor;class os extends nt(_){constructor(){super(...arguments),this.vertical=!1}static get styles(){return[Nc]}handleSlotchange({target:t}){t.assignedElements().forEach(e=>{e.size=this.size})}render(){return u`
...
`;class ni extends nt(_,{validSizes:["s","m","l"]}){static get styles(){return[Qo,ii]}firstUpdated(t){super.firstUpdated(t),this.setAttribute("role","separator")}}y("sp-menu-divider",ni);var li=k`
...
`,fi=Object.defineProperty,yi=Object.getOwnPropertyDescriptor,Re=(r,t,e,o)=>{for(var a,s=o>1?void 0:o?yi(t,e):t,c=r.length-1;c>=0;c--)(a=r[c])&&(s=(o?a(t,e,s):a(s))||s);return o&&s&&fi(t,e,s),s};class be extends _{constructor(){super(...arguments),this.dialog=!1,this.open=!1,this.placement="none",this.tip=!1}static get styles(){return[vi]}renderTip(){return u`
            <div id="tip">
                <svg
...
`,Mi=Object.defineProperty,_i=Object.getOwnPropertyDescriptor,Q=(r,t,e,o)=>{for(var a,s=o>1?void 0:o?_i(t,e):t,c=r.length-1;c>=0;c--)(a=r[c])&&(s=(o?a(t,e,s):a(s))||s);return o&&s&&Mi(t,e,s),s};const Zr=3840;class X extends _{constructor(){super(),this.vertical=!1,this.resizable=!1,this.collapsible=!1,this.primaryMin=0,this.primaryMax=Zr,this.secondaryMin=0,this.secondaryMax=Zr,this.firstPaneSize="auto",this.enoughChildren=!1,this.viewSize=0,this.offset=0,this.minPos=0,this.maxPos=Zr;const t=window.ResizeObserver;t&&(this.observer=new t(()=>{this.rect=void 0,this.updateMinMax()}))}static get styles(){return[Oi]}connectedCallback(){var t;super.connectedCallback(),(t=this.observer)==null||t.observe(this)}disconnectedCallback(){var t;(t=this.observer)==null||t.unobserve(this),super.disconnectedCallback()}get splitterSize(){return this._splitterSize||(this._splitterSize=this.splitter&&Math.round(parseFloat(window.getComputedStyle(this.splitter).getPropertyValue(this.vertical?"height":"width")))||2),this._splitterSize}render(){const t={"is-resized-start":this.splitterPos===this.minPos,"is-resized-end":this.splitterPos&&this.splitterPos>this.splitterSize&&this.splitterPos===this.maxPos,"is-collapsed-start":this.splitterPos===0,"is-collapsed-end":this.splitterPos&&this.splitterPos>=Math.max(this.splitterSize,this.viewSize-this.splitterSize)};return u`
  ...
  `),customElements.define("illustrated-message",Qr);const Bs=()=>new Fi;class Fi{}const Jr=new WeakMap,Ps=Ie(class extends Oo{render(r){return $}update(r,[t]){var e;const o=t!==this.G;return o&&this.G!==void 0&&this.ot(void 0),(o||this.rt!==this.lt)&&(this.G=t,this.ct=(e=r.options)===null||e===void 0?void 0:e.host,this.ot(this.lt=r.element)),$}ot(r){var t;if(typeof this.G=="function"){const e=(t=this.ct)!==null&&t!==void 0?t:globalThis;let o=Jr.get(e);o===void 0&&(o=new WeakMap,Jr.set(e,o)),o.get(this.G)!==void 0&&this.G.call(this.ct,void 0),o.set(this.G,r),r!==void 0&&this.G.call(this.ct,r)}else this.G.value=r}get rt(){var r,t,e;return typeof this.G=="function"?(t=Jr.get((r=this.ct)!==null&&r!==void 0?r:globalThis))===null||t===void 0?void 0:t.get(this.G):(e=this.G)===null||e===void 0?void 0:e.value}disconnected(){this.rt===this.lt&&this.ot(void 0)}reconnected(){this.ot(this.lt)}});class Os extends it{constructor(...t){super(...t),V(this,"progressContainer",Bs())}connectedCallback(){super.connectedCallback(),q.instance.addEventListener(st.PLUGIN_LOADED,async()=>{const t=gt("div",{class:"plugin-root","data-testid":"plugin-root"});this.renderRoot.prepend(t),await this.loadPluginStylesheet(),t.addEventListener(Ut.SHOW_LOADER,this.displayLoader.bind(this)),t.addEventListener(Ut.TOAST,this.sendToast),t.addEventListener(Ut.HIDE_LOADER,this.hideLoader.bind(this));const{context:e}=D.appStore,{activePlugin:o}=e;o.decorate(t,o.data,D.appStore.searchQuery),t.setAttribute("id",`${o.config.title.toLowerCase()}-plugin`)}),q.instance.addEventListener(st.PLUGIN_UNLOADED,()=>{const t=this.renderRoot.querySelector(".plugin-root");t&&(this.hideLoader(),t.remove())}),q.instance.addEventListener(st.SEARCH_UPDATED,()=>{const t=this.renderRoot.querySelector(".plugin-root");if(t){t.innerHTML="";const{context:e}=D.appStore,{activePlugin:o}=e;o.decorate(t,o.data,D.appStore.searchQuery)}})}loadPluginStylesheet(){return new Promise(t=>{const e=document.createElement("link");e.setAttribute("rel","stylesheet"),e.onload=()=>t(),e.onerror=()=>t();const o=D.appStore.context.activePlugin.path.replace(".js",".css");e.setAttribute("href",o),e.setAttribute("type","text/css"),this.renderRoot.append(e)})}displayLoader(){var t;(t=this.progressContainer.value)==null||t.classList.add("visible")}hideLoader(){var t;(t=this.progressContainer.value)==null||t.classList.remove("visible")}sendToast(t){q.instance.dispatchEvent(new CustomEvent(Ut.TOAST,{detail:t.detail}))}render(){return u`
    ...
    `}}function Y(r,t={}){Y.defer=Y.defer||[];const e=o=>{Y[o]=Y[o]||((...a)=>Y.defer.push({fnname:o,args:a}))};Y.drain=Y.drain||((o,a)=>{Y[o]=a,Y.defer.filter(({fnname:s})=>o===s).forEach(({fnname:s,args:c})=>Y[s](...c))}),Y.on=(o,a)=>{Y.cases[o]=a},e("observe"),e("cwv");try{if(window.hlx=window.hlx||{},!window.hlx.rum){const s=new URLSearchParams(window.location.search).get("rum")==="on"?1:100,c=`${window.location.href.split("").reduce((l,d)=>(l<<5)-l+d.charCodeAt(0)|0,0)}-${new Date().getTime()}-${Math.random().toString(16).substr(2,14)}`,i=Math.random(),n=i*s<1;window.hlx.rum={weight:s,id:c,random:i,isSelected:n,sampleRUM:Y}}const{weight:o,id:a}=window.hlx.rum;window.hlx&&window.hlx.rum&&window.hlx.rum.isSelected&&(((s=t)=>{const c=JSON.stringify({weight:o,id:a,referer:window.location.href,checkpoint:r,...t}),i=`https://rum.hlx.page/.rum/${o}`;navigator.sendBeacon(i,c),console.debug(`ping:${r}`,s)})(t),Y.cases[r]&&Y.cases[r]())}catch(o){}}function Ms(r,t=[],e=!0){if(r){const o={},a=function(s,c=!0){const i={};return s.querySelectorAll(":scope > div").forEach(n=>{if(n.children){const l=[...n.children];if(l[1]){const d=l[1],p=c?Ls(l[0].textContent):l[0].textContent;let h="";if(d.querySelector("a")){const g=[...d.querySelectorAll("a")];h=g.length===1?g[0].href:g.map(b=>b.href)}else if(d.querySelector("img")){const g=[...d.querySelectorAll("img")];h=g.length===1?g[0].src:g.map(b=>b.src)}else if(d.querySelector("p")){const g=[...d.querySelectorAll("p")];h=g.length===1?g[0].textContent:g.map(b=>b.textContent)}else h=n.children[1].textContent;i[p]=h}}}),i}(r,e);return Object.keys(a).forEach(s=>{t.includes(s)||(e?o[function(c){return Ls(c).replace(/-([a-z])/g,i=>i[1].toUpperCase())}(s)]=a[s]:o[s]=a[s])}),o}}function _s(r){const t=r.querySelector(".library-metadata");if(t){const e=Ms(t,["style"]);return t.remove(),e}}function Rs(r,t=!0){if(!r)return;const e=r.className.split(" "),o=e.shift();if(!t)return o;const a=e.filter(s=>s!=="sidekick-library"&&s!=="");return a.length>0?`${o} (${a.join(", ")})`:o}V(Os,"styles",k`
    sp-sidenav {
      width: 100%;
    }
...
`,Wi=Object.defineProperty,Gi=Object.getOwnPropertyDescriptor,Us=(r,t,e,o)=>{for(var a,s=o>1?void 0:o?Gi(t,e):t,c=r.length-1;c>=0;c--)(a=r[c])&&(s=(o?a(t,e,s):a(s))||s);return o&&s&&Wi(t,e,s),s};class ro extends _{constructor(){super(...arguments),this.label=""}static get styles(){return[Vi]}render(){return this.variant==="file"?(t=>u`
    <svg
        class="file"
        role="img"
        viewBox="0 0 128 128"
...
`,on=Object.defineProperty,sn=Object.getOwnPropertyDescriptor,Ns=(r,t,e,o)=>{for(var a,s=o>1?void 0:o?sn(t,e):t,c=r.length-1;c>=0;c--)(a=r[c])&&(s=(o?a(t,e,s):a(s))||s);return o&&s&&on(t,e,s),s};class ao extends _{constructor(){super(...arguments),this.opened=!1,this.textOnly=!1}static get styles(){return[rn]}render(){return u`
            <slot></slot>
